<template>
  <div>
    <header class="topbar">
      ...
      <router-link to="/simulation/scenes" class="iconbtn" title="场景仿真">🚛 场景仿真</router-link>
      <UserMenu />
...
// TaskQueue / Kpi / Alerts / TaskCreate / Rollback / LogViewer are rendered by
// RightTabs, not here — these imports were leftovers from before that refactor.
...
// Esc closes the topmost layer first. Hotkeys themselves are owned by
// `SimulationRoot.vue`, which broadcasts them as CustomEvents — listening for
// `keydown` here as well used to toggle twice and cancel itself out.
