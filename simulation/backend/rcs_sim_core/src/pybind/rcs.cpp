...
PYBIND11_MODULE(_core, m) {
  ...
  // MuJoCo-native IK: no external kinematics library required.
  py::class_<rcs::common::MjIK, rcs::common::Kinematics,
             std::shared_ptr<rcs::common::MjIK>>(common, "MjIK")
      .def(py::init([](const rcs::sim::Sim& sim,
                       const std::vector<std::string>& joint_names,
                       const std::string& site_name,
                       const std::string& base_name) {
             return std::make_shared<rcs::common::MjIK>(
                 sim.m, sim.d, joint_names, site_name, base_name);
           }),
           py::arg("sim"), py::arg("joint_names"), py::arg("site_name"),
           py::arg("base_name"));
  ...
  py::class_<rcs::sim::SimRobot, rcs::common::Robot,
      ...
      .def(py::init<std::shared_ptr<rcs::sim::Sim>, rcs::sim::SimRobotConfig,
                    bool>(),
           py::arg("sim"), py::arg("cfg"),
           py::arg("register_convergence_callback") = true)
