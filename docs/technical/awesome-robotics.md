...
- [人工智能机器人学](https://www.udacity.com/course/artificial-intelligence-for-robotics--cs373) **Udacity**
- [机器人学纳米学位](https://www.udacity.com/course/robotics-software-engineer--nd209) **Udacity** :dollar:
- [自主移动机器人](https://courses.edx.org/courses/course-v1:ETHx+AMRx+2T2019/5b151c51e8bf47c29d97f8a12369df17/) **edX**
- [欠驱动机器人学](http://underactuated.csail.mit.edu/underactuated.html) **MIT CSAIL**
...
- [飞行机器人自主导航](https://www.edx.org/course/autonomous-navigation-flying-robots-tumx-autonavx-0) **edX**
- [GRAP Lab 机器人学专项](https://www.coursera.org/specializations/robotics) **Coursera** :dollar:
- [移动机器人控制](https://www.coursera.org/course/conrob) **Coursera**
- [QUT 机器人学院](https://robotacademy.net.au/) **QUT**
...
- [机器人学：视觉、智能与机器学习](https://www.edx.org/course/robotics-vision-intelligence-machine-pennx-robo2x) **edX**
...
- [哥伦比亚大学机器人学](https://www.edx.org/course/robotics-columbiax-csmm-103x-2) **edx**
- [现代机器人学：力学、规划与控制](https://www.coursera.org/specializations/modernrobotics?) **Coursera**
- [ROS 机器人操作系统实战](https://www.edx.org/course/hello-real-world-with-ros-robot-operating-system-2) **edx**
- [高级机器人学](https://people.eecs.berkeley.edu/~pabbeel/cs287-fa19/) **UC 伯克利**
- [Arduino 机器人与设备构建](https://www.coursera.org/learn/arduino) **Coursera**
...
- [自主移动机器人导论（智能机器人与自主系统系列）](http://www.amazon.com/Introduction-Autonomous-Mobile-Intelligent-Robotics/dp/0262015358/) :dollar:
- [Springer 机器人学手册](https://www.amazon.com/Springer-Handbook-Robotics-Handbooks/dp/3319325507/) :dollar:
- [规划算法](http://planning.cs.uiuc.edu/)
- [ROS 轻松入门](https://cse.sc.edu/~jokane/agitr/agitr-letter.pdf)
- [机器人操作的数学导论](http://www.cds.caltech.edu/~murray/mlswiki/?title=First_edition)
- [机器人学编程](http://wiki.roboteducation.org/Introduction_to_Computer_Science_via_Robots)
- [机器人学、视觉与控制：MATLAB 算法（Springer 先进机器人学系列）](http://www.amazon.com/Robotics-Vision-Control-Fundamental-Algorithms/dp/3642201431) :dollar:
- [INTECH 机器人学书籍](http://www.intechopen.com/subjects/robotics)
- [自主机器人导论](https://github.com/correll/Introduction-to-Autonomous-Robots/releases)
- [机器人运动原理：理论、算法与实现](https://www.amazon.com/Principles-Robot-Motion-Implementations-Intelligent/dp/0262033275) :dollar:
- [现代机器人学导论：力学、规划与控制](http://hades.mech.northwestern.edu/index.php/LynchAndPark) [[pdf](http://hades.mech.northwestern.edu/images/7/7f/MR.pdf)]
- [ROS 机器人编程](https://www.amazon.com/Programming-Robots-ROS-Practical-Introduction/dp/1449323898/) :dollar:
- [ROS 机器人编程实战](https://www.amazon.com/Learning-ROS-Robotics-Programming-Second/dp/1783987588) :dollar:
- [ROS 机器人编程进阶](https://www.amazon.com/Mastering-ROS-Robotics-Programming-Lentin-Joseph/dp/1783551798) :dollar:
...
**[ROS](http://www.ros.org/)**
机器人操作系统（Robot Operating System）是一套用于编写机器人软件的灵活框架。它提供了工具库、算法库和一系列约定，旨在简化跨多种机器人平台创建复杂、鲁棒机器人行为的过程。

**[ROS2](https://index.ros.org/doc/ros2/)**
ROS 的全新版本，采用了激进的设计改进，相比旧版 ROS 有显著提升。

**[RobWork](http://www.robwork.dk/apidoc/nightly/rw/)**
面向机器人系统仿真与控制的 C++ 库集合，适用于研究与教学及实际机器人应用。

**[MRPT](http://www.mrpt.org/)**
移动机器人编程工具包，为开发者提供涵盖常见机器人学研究领域的数据结构和算法的可移植、经过良好测试的应用程序与库。

**[Robotics Library](http://www.roboticslibrary.org/)**
自包含的 C++ 机器人库，支持运动学、动力学、硬件抽象、运动规划、碰撞检测与可视化。

**[Simbad](http://simbad.sourceforge.net/)**
基于 Java 和 Jython 的 2D/3D 仿真器。

**[Morse](https://www.openrobots.org/wiki/morse/)**
通用室内外 3D 仿真器。

**[Carmen](http://carmen.sourceforge.net/)**
移动机器人控制开源软件集合，提供基础导航原语，包括底盘与传感器控制、日志记录、障碍物规避、定位、路径规划和地图构建。

**[Peekabot](http://www.peekabot.org/)**
实时网络化 3D 机器人可视化工具，采用 C++ 编写。

**[YARP](http://www.yarp.it/)**
又一个机器人平台（Yet Another Robot Platform）。

**[V-REP](http://www.coppeliarobotics.com/)**
机器人仿真器，3D，支持 Lua 脚本，提供 C/C++、Python、Java、Matlab、URBI API，配备 2 套物理引擎和完整运动学求解器。

**[Webots](https://www.cyberbotics.com/overview)**
用于建模、编程和仿真移动机器人的开发环境。

**[Drake](http://drake.mit.edu/)**
非线性动力学系统的规划、控制与分析工具箱。

**[NRP (Neurobotics Platform)](https://neurorobotics.net/)**
互联网可访问的仿真系统，支持由尖峰神经网络控制的机器人仿真。

**[The Player Project](http://playerstage.sourceforge.net/)**
机器人与传感器应用的免费软件工具。

**[Open AI's Roboschool](https://github.com/openai/roboschool)**
开源机器人仿真软件，与 OpenAI Gym 集成。

**[ViSP](http://visp.inria.fr/)**
开源视觉伺服平台库，可计算适用于机器人系统的控制律。

**[ROS Behavior Trees](https://github.com/miccol/ROS-Behavior-Tree)**
以行为树形式在 ROS 中创建机器人行为的开源库。

**[g2core](https://github.com/synthetos/g2)**
面向 CNC 与机器人的开源运动控制软件，设计用于在 Arduino Due 级微控制器上运行。

**[ur5controller](https://github.com/roboticsleeds/ur5controller)**
与 ROS 集成的开源 OpenRAVE UR5 机器人控制器。

**[RBDL](https://github.com/rbdl/rbdl)**
开源（zlib）C++ 库，支持前向与逆向动力学及运动学，亦支持接触与闭环约束。

**[Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub)**
Unity 机器人仿真开源包、教程与其他资源的中枢仓库，含 ROS 集成新支持。
...
- [CISM IFToMM 机器人设计、动力学与控制研讨会（RoManSy）](http://www.romansy2016.org/)
- [IEEE 决策与控制会议（CDC）](http://ieeexplore.ieee.org/servlet/opac?punumber=1000188)
- [IEEE 康复机器人国际会议（ICORR）](http://www.rehabrobotics.org/)
- [IEEE 机器人与自动化国际会议（ICRA）](http://www.ieee-ras.org/conferences-workshops/fully-sponsored/icra)
- [IEEE/RSJ 智能机器人与系统国际会议（IROS）](http://www.iros.org/)
- [IEEE-RAS 人形机器人国际会议（Humanoids）](http://ieeexplore.ieee.org/servlet/opac?punumber=1002042)
- [机器人学国际实验研究研讨会（ISRR）](http://ifrr.org/isrr.php)
- [机器人学国际实验研讨会（ISER）](http://ifrr.org/iser.php)
...
- [RobotChallenge](http://www.robotchallenge.org/)
- [DARPA 机器人挑战赛](http://www.theroboticschallenge.org/)
- [欧洲机器人挑战赛](http://www.euroc-project.eu/)
- [First 机器人竞赛](http://www.firstinspires.org/robotics/frc)
- [VEX 机器人竞赛](https://www.vexrobotics.com/)
- [RoboCup](http://www.robocup.org/)
- [RoboCupJunior](https://junior.robocup.org/)
- [Eurobot](http://www.eurobot.org/) 国际学生机器人竞赛
- [RoboMasters](https://www.robomaster.com/en-US)
- [RoboSoft, Grand Challenge](http://www.robosoftca.eu/)
- [智能地面车辆竞赛（IGVC）](http://www.igvc.org/)
...
- [iRobot](http://www.irobot.com/) 著名 [Roomba](https://en.wikipedia.org/wiki/Roomba) 扫地机器人的制造商
- [PAL Robotics](http://pal-robotics.com)
- [Aldebaran Robotics](https://www.aldebaran.com/en) 制造了 [NAO 机器人](https://www.youtube.com/watch?v=nNbj2G3GmAo)
- [ABB Robotics](http://new.abb.com/products/robotics) 全球最大工业机器人制造商
- [KUKA Robotics](http://www.kuka-robotics.com/en/) 以工厂自动化为目标的主要工业机器人制造商
- [FANUC](http://www.fanucamerica.com/) 拥有最大装机量的工业机器人制造商
- [Rethink Robotics](http://www.rethinkrobotics.com/) 制造了协作机器人 [Baxter](https://www.youtube.com/watch?v=fCML42boO8c)
- [DJI](http://www.dji.com/) 商用及工业无人机领域领导者
- [The Construct Sim](http://www.theconstructsim.com/) 基于云的工具，用于构建现代化机器人仿真
...
- [IEEE Spectrum 机器人学](http://spectrum.ieee.org/robotics)
- [MIT Technology Review 机器人学](https://www.technologyreview.com/c/robotics/)
- [Reddit 机器人学版块](https://www.reddit.com/r/robotics/)
- [RosCON 会议（含演讲视频）](http://roscon.ros.org/2015/)
- [卡内基·梅隆机器人学院](http://education.rec.ri.cmu.edu/)
- [让我们做机器人](http://letsmakerobots.com/)
- [如何学习机器人学？](https://www.quora.com/How-do-I-learn-robotics)
- [NXT Lego MindStorms NXT-G 代码教程](http://www.drgraeme.net/DrGraeme-free-NXT-G-tutorials/ChV4.htm)
- [StackExchange 机器人学社区](https://robotics.stackexchange.com)
- [47 种可编程机器人套件](http://www.intorobotics.com/47-programmable-robotic-kits/)
- [Linorobot](https://linorobot.org/) 一套 DIY ROS 兼容机器人
- [六足机器人仿真器](https://github.com/mithi/hexapod) — 在网页中求解与可视化六足机器人逆运动学和步态
- [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) — Python 实现的各类机器人学算法
