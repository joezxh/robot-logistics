...
**Main data structures:**
  ...
  * [mjUI](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APItypes.md#mjui): An entire UI.

  * [mjuiState](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APItypes.md#mjuistate): Global UI state.

  * [mjuiDef](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APItypes.md#mjuidef): One entry in the definition table used for UI construction.
...
**Main functions:**
  ...
  * [mjui_update](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APIfunctions.md#mjui-update): Main UI update function.

  * [mjui_render](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APIfunctions.md#mjui-render): Renders the UI.

  * [mjui_event](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APIfunctions.md#mjui-event): Low-level event handler.

  * [mjui_add](https://mujoco.readthedocs.io/en/stable/programming/APIreference/APIfunctions.md#mjui-add): Helper function used to construct a UI.
